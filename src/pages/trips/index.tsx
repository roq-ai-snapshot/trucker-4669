...
export function TripListPage(props: TripListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getTrips({
        relations: ['vehicle', 'loading_slip.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('vehicle', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('loading_slip', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'loading_slip',
          header: 'Loading Slip',
          accessorKey: 'loading_slip',
          cell: ({ row: { original: record } }: any) => record?._count?.loading_slip,
        }
      : null,
