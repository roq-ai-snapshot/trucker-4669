...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Drivers', path: '/drivers', entity: 'driver', service: AccessServiceEnum.PROJECT, icon: FiUserCheck },
    ...
    { name: 'Suppliers', path: '/suppliers', entity: 'supplier', service: AccessServiceEnum.PROJECT, icon: FiBox },
    {
      name: 'Transporters',
      path: '/transporters',
      entity: 'transporter',
    ...
    { name: 'Trips', path: '/trips', entity: 'trip', service: AccessServiceEnum.PROJECT, icon: FiMapPin },
    { name: 'Vehicles', path: '/vehicles', entity: 'vehicle', service: AccessServiceEnum.PROJECT, icon: FiBox },
